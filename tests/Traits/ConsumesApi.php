...
trait ConsumesApi
{
    ...
    protected function assertSuccessResponse($code = Response::HTTP_OK)
    {
        ...
        $this->assertEquals($code, $this->response->getStatusCode(), $this->getResponseMessage());
    ...
    protected function assertResponseMessage($message)
    {
        $this->assertEquals($message, $this->getResponseMessage());
    }
